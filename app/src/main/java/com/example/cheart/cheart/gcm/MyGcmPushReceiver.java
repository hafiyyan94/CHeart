package com.example.cheart.cheart.gcm;
...
import com.example.cheart.cheart.activity.ChatRoomActivity;
import com.example.cheart.cheart.activity.MainActivityChat;
        ...
        if (!isBackground) {
            ...
            try {
                ...
                if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                    ...
                    // app is in background. show the message in notification try
                    Intent resultIntent = new Intent(getApplicationContext(), MainActivityChat.class);
